    ...
    <>
      ...
      <div className=" page-grid-inside-5-cl  ">
        <div className="  grid-tab-column-1  font-size-1 grid-6-column-mobile grid-1-column  grid-child  ">
          <div className="inside-page-padding termine-Datum border-radius font-size-3">
            30/03
          </div>

          <div className="inside-page-padding border-radius termine-titel font-size-4 font-script">
            Bekenntnisse an das Misstrauen
          </div>
        </div>
        ...
        <div className="   grid-tab-column-1   font-size-1 grid-6-column-mobile grid-1-column  grid-child  ">
          ...
          <div className="inside-page-padding border-radius termine-titel font-size-4 font-script">
            Sonderaugabe der <br></br> Bella Triste
          </div>
        </div>
        ...
        <div className="no-scroll-bar grid-6-column-mobile mobile-grid-row-start-2 termine-text background-color-grey inside-page-padding border-radius scrollable-element grid-tab-column-1 grid-1-column">
          ...
          unterschiedlichen Kontexten stammen können. Drei Texte werden mit
          einem Preisgeld ausgezeichnet und auf dem Festival inszeniert. Die
          Jury besteht aus Olufemi Atibioke, Deniz Bolat und Laura Shirin, die
          euch im Anschluss an die Auswahlphase bei der Umsetzung eurer
          Texteinreichungen und Konzepte sowohl inhaltlich, als auch
          dramaturgisch zur Seite stehen werden. Wie die Texte umgesetzt werden,
          bleibt euch dabei in Absprache mit den Mentor*innen freigestellt - ob
          klassisch, experimentell, visuell, interaktiv, medial oder etwas
          anderes. Natürlich solange es sich im vorgegebenen Budget bewegt. Die
          Teilnahme an einem Probenwochenende mit den Mentor*innen vor dem
          Festival ist verpflichtend. Eure Einsendungen könnt ihr als
          PDF-Dateien bis zum 30.03.2023 an presse@prosanova.net schicken, gerne
          auch mit Konzept, wie ihr euch eure Inszenierung/Umsetzung beim
          Festival vorstellen könnt. Der Open Call richtet sich an Menschen mit
        ...
        <div className="no-scroll-bar grid-6-column-mobile mobile-grid-row-start-4 termine-text background-color-grey inside-page-padding border-radius scrollable-element grid-tab-column-1 grid-1-column">
          ...
          und Karosh Taha sind zu Gast und lesen für uns aus neuen und bekannten
          Büchern. Wir wollen uns auf das Festival einstimmen und ersten Worten
          lauschen. Begleitet wird das Ganze vom NDR. Mehr Informationen und
          Tickets hier:
          <Link className="Links" to=" https://stjakobi.de/veranstaltungen/prosanova-auftakt-mit-behzad-karim-khani-karosh-taha-und-heike-geissler">
            {" "}
        ...
        <div className="no-scroll-bar grid-6-column-mobile mobile-grid-row-start-6 termine-text background-color-grey inside-page-padding border-radius scrollable-element grid-tab-column-1 grid-1-column">
          ...
          Jakobi widmen wir uns dem Kollektiven als Praxis im Literaturbetrieb.
          Wie originell können wir sein, wenn wir gemeinsam arbeiten? Welche
          Rolle nimmt die soziale Praxis neben der künstlerischen ein und wie
          viele Kompromisse müssen eingegangen werden? Welche Ausschlüsse
          geschehen, wenn wir uns auf ganz bestimmte Kollektivpartner:innen
          einlassen? All das wollen wir uns gemeinsam fragen - und holen uns
          dafür Unterstützung von einzelnen Vertreter:innen aus verschiedenen
          Kollektiven. Mit dabei: Lynn Takeo Musiol (dyke dogs), Kyra Schmidt
          (Biwi Kefempom), Sandra Burckhardt (Wiese), Tristan Marquardt (Q13),
          Alexnder Rupflin (Hermes Baby) und Maren Wurster. Der Fokus liegt an
          diesem Abend auf dem Gemeinsamen - wir wollen diskutieren und so
