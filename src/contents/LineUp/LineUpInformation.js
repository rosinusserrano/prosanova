      ...
      <>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/photo_2023-06-16 00.14.48.jpeg"
          ></img>
          <p className="font-size-1">
            <PrettyName name={"Tilman"} /> <PrettyName name={"Busch"} />,
            geboren und aufgewachsen in Göttingen. Studierte in Halle (Saale)
            Soziologe und Wirtschaftswissenschaften. Seit 2021 Literarisches
            Schreiben, Medien und Kulturpolitik in Hildesheim. Außerdem ist er
            in der Redaktion von Litradio und für das PROSANOVA 23 Praktikant im
            Bereich Produktion.
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/Jenifer-BeckerFoto_FranziskaGilli.jpg"
          ></img>
          <p className="font-size-1">
            <PrettyName name={"Jenifer"} /> <PrettyName name={"Becker"} />
            (*1988) ist eine in Berlin lebende Autorin und Literatur- und
            Kulturwissenschaftlerin. Sie studierte Journalistik und Kreatives
            Schreiben. 2021 promovierte sie am Institut für Literarisches
            Schreiben und Literaturwissenschaft der Universität Hildesheim, wo
            sie als Postdoc lehrt und forscht. Sie schreibt Prosa und
            multimediale Performances. Ihre Lehr- und Forschungsschwerpunkte
            liegen auf autobiografischen Schreibformen, Gender Studies,
            Populärkultur sowie digitaler Literatur, insbesondere Schreiben mit
            KI-Tools. Aktuelle künstlerisch-wissenschaftliche Forschungsprojekte
            befassen sich mit dem Einfluss lernfähiger Technologien (KI) auf
            Schreibprozesse, Schreibverfahren sowie Genres. Ihr Roman „Zeiten
            der Langeweile" erscheint 2023 bei Hanser Berlin.
          </p>
          <a
            href="https://www.hanser-literaturverlage.de/buch/zeiten-der-langeweile/978-3-446-27804-2/"
            target="_blank"
          >
          ...
          <br></br>
          <a
            href="https://www.uni-hildesheim.de/literaturinstitut/jenifer-becker/"
            target="_blank"
          >
        ...
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/KopievonFerretti_Giorgio_credits_David_Tiefenthaler.jpg"
          ></img>
          <p className="font-size-1">
            <PrettyName name={"Giorgio"} /> <PrettyName name={"Ferretti"} />,
            ist 1990 in Lecco, Italien, geboren und wohnt seit 2014 in
            Deutschland. Seit 2019 studiert er am Deutschen Literaturinstitut in
            Leipzig. Er wirkt in dem Verlagskollektiv hochroth Leipzig mit und
            ist in der Redaktion der Literaturzeitschrift Edit. Prosa, Lyrik,
            Essays und Dramatisches von ihm wurden in verschiedenen
            Zeitschriften veröffentlicht, u.A. in BELLA Triste, PS Politisch
            Schreiben, Das Narr. 2022 hat er den exil-Dramatiker*innenpreis
            gewonnen. <br></br> Bildcredits: David Tiefenthaler
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/Kopievon 12-22_DuyguAgal_Handprints_003-Wiederhergestellt Kopie.jpg"
          ></img>
          <p className="font-size-1">
            <PrettyName name={"Duygu"} /> <PrettyName name={"Ağal"} />, ist
            Autor*in. Der*die in Hamburg aufgewachsene*r lebt in Berlin und hat
            im April vergangenen Jahres seinen*ihren Debütroman Yeni Yeşerenler
            mit dem Korbinian Verlag publiziert. Ağal hat mit Yeni Yeşerenler
            eine fragmentarische Coming-of-Age-Geschichte geschrieben, in der
            goldene Birkenstocks und anstrengende Alman-Therapeutinnen genauso
            ihren Platz haben, wie die abweisenden Insignien einer Welt, die
            nicht für einen gemacht scheint – aber auch und gerade deshalb:
            queer-lesbische Liebe, ein neues Leben, Frauenfussball, Gewalt,
            Verzweiflung, Emanzipation, Selbstbewusstsein, Freund*innenschaft
            und so vieles mehr. Eden Jetschmann (IG: @jetphoto)
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/DeborahFallis.jpg"
          ></img>
          <p className="font-size-1">
            <PrettyName name={"Deborah"} /> <PrettyName name={"Fallis"} />,
            studierte Allgemeine und Vergleichende Literaturwissenschaft,
            Judaistik und Neuere deutsche Literaturwissenschaft in Berlin und
            Hannover. In ihrer Mastarbeit beschäftigte sie sich u.a. mit
            Wehrhaftigkeit in der Lyrik May Ayims und Semra Ertans. Sie
            promoviert im Rahmen des DFG-Projekts „Empathie und Störung. Praxen,
            Poetiken und Traditionen der literarischen Verhandlung von rechter
            Gewalt in der Demokratie“ zur literarischen Darstellung rechter
            Gewalt aus postmigrantischen Perspektiven.
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/AylinHimmetoglu_Bild.jpeg"
          ></img>
          <p className="font-size-1">
            <PrettyName name={"Aylin"} /> <PrettyName name={"Himmetoğlu"} />,
            (sie/ihr) studierte Kulturwirtschaft und lebt in Berlin. Sie
            schreibt und spricht über Kultur, systematische Ausbeutung und
            linken Feminismus. Dazu nutzt sie unterschiedliche Plattformen: Sie
            ist Co-Host des Podcast Bao und Börek, der gesellschaftliche
            Verhältnisse, Identität und Empowerment thematisiert. Sie ist
            Speakerin und Moderatorin auf Podien und nutzt Instagram für
            digitales Storytelling. Außerdem ist sie Organisatorin von Community
            Events und politische Bildnerin im Bereich der
            diskriminierungskritischen Jugendarbeit. <br></br>Foto: Tammy-Rose
            (@chinyyyere)
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/IMG_6883.PNG"
          ></img>
          <p className="font-size-1">
            <PrettyName name={"Aya"} /> <PrettyName name={"Zavê"} />, in Hasaka
            geboren, studiert derzeit Medien an der Universität Hildesheim. Sie
            ist eine vielseitige Künstlerin, die sich auf biographische Kunst im
            Medium Film spezialisiert hat. Während ihres Studiums arbeitete sie
            erfolgreich als freiberufliche Übersetzerin, zuletzt beim arabischen
            Theatertreffen in Hannover. Aya Zavê widmet sich nun ihrer
            Leidenschaft dem Schreiben und der arabischen Kalligraphie.
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/IMG_3073.HEIC"
          ></img>
          <p className="font-size-1">
            <PrettyName name={"Armin"} /> <PrettyName name={"Djamali"} />
            hat einen Bachelor in Nah- und Mitteloststudien und war
            Mitherausgeber der Literaturzeitschrift BELLA triste. Er ist Teil
            von copwatchffm und kuratiert, sowie lektoriert Buch- und
            Magazinprojekte, zuletzt bei edition assemblage. Er interessiert
            sich für Grenzen, abolutionistische Ansätze und Empowerment.
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/Credits_ThomasYutakaSchwarz.JPG"
          ></img>
          <p className="font-size-1">
            <PrettyName name={"Aidan"} /> <PrettyName name={"Riebensahm"} />
            alias aidan lavender arbeitet als freischaffende*r
            Dramaturg*in, Übersetzer*in und Moderator*in in Berlin. Aidan kam
            Anfang der 1990er im Leinebergland zur Welt, wuchs dort auf und
            absolvierte am Fachbereich für Kulturwissenschaften und ästhetische
            Kommunikation an der Stiftung Universität Hildesheim ein Bachelor-
            und Masterstudium mit dem Schwerpunkt Theater.
          </p>
        </div>
      </>
    ),
      ...
      <>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/str_fb.jpg"
          ></img>
          <p className="font-size-1">
            Deutsch: <PrettyName name={"Sth"} /> that runs ist ein Netzwerk von
            Synth Spieler*innen. Wir spielen und improvisieren mit analogen
            Synthesizern live auf der Bühne. <br></br> Englisch: sth that runs
            is a network of synth players. we play and improvise with analog
            synthesizers live on stage.
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <p className="font-size-1">
            ...
            Sehnsucht nach Einigkeit, kollektiver Freude und radikaler
            Solidarität in der Musikindustrie. Ihre Clubsets spiegeln ihre
            jeweiligen Einflüsse wieder: eine innige Verschmelzung aus
            Afro-Beats, Baile Funk, UK Bass, House, Dancehall, Perreo,
            US-Club-Music und Rap.
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/yung_womb.jpeg"
          ></img>
          <p className="font-size-1">
            yung_womb ist DJ und Performerin aus Hamburg. Sie ist Teil der SLIC
            Unit einem BIPoC DJ-Netzwerk, welches sie im Jahr 2020 mitbegründet
            hat. In ihren Club-Sets spielt sie uns mit Baile Funk, Guaracha,
            Afrobeats, Dembow, Kuduro, DrumCore und Ballroom gnadenlos, aber
            liebevoll gegen die Wand und fordert alle unsere Sinne mit den
            schweißtreibenden Sounds der Diaspora. Es ist schwierig sich nicht
            von ihren Performances und Selection mitreißen zu lassen und erneut
            unseren Geist mit dem Culo zu verbinden.
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/Slimgirlfat.jpeg"
          ></img>
          <p className="font-size-1">
            Singer, Producer and DJ slimgirl fat loves to blur genre conventions
            of all kinds. Not only in her own music but also on the decks. Her
            favorite tunes aim to have a special, vexing, and emotional
            momentum. Her sound collection reaches from contemporary Pop,
            Hip-Hop, UK Jungle & Hardcore to Dancehall and Reggaeton.
            „Disorienting, dystopian, delicious.“
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/R0030055.JPG"
          ></img>
          <p className="font-size-1">
            <PrettyName name={"SAVO"} />
            ist eine junge, kurdische Künstlerin aus Hannover. Ihre Musik
            beschreibt sie als eine Mischung aus Neo-Soul, R’n‘B und Hip-Hop und
            ist bereits seit vier Jahren auf den Bühnen Hannovers zu hören und
            dieses Jahr zum ersten Mal in der UK in Glasgow. SAVO ist die
            Bezeichnung von reinem Wasser, welches aus einer Wasserquelle kommt
            in der eine Gischt entsteht. Damit verbindet SAVO ihre kurdische
            Identität und ihre Kunst mit allem Organischen und lässt ihr Herz
            mit all ihren Gefühlen und Gedanken in ihre lyrische, melodische
            Musik, wie reines Wasser, hineinfließen. In diesem Jahr erscheint
            ihre erste Single. Zusammen mit Anjoni und Taro an E-Gitarre und
            Bass performt Sie ihre, noch nicht veröffentlichten, Songs live.
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <p className="font-size-1">
            <PrettyName name={"Pavement Gum"} />
          </p>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/skilan.jpg"
          ></img>
          <p className="font-size-1">
            <PrettyName name={"Skilan"} />
            has a classical music education, but during the time she discovered
            a big passion for electronic music as well. her strong sound mixes
            some hard bass tunes with shaky bangers and some slapping breaks.
            skilan is located in hannover and co-founded the music- and party
            collective pavement gum.
          </p>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
          ...
          ></img>
          <p className="font-size-1">
            Hanover-based DJ <PrettyName name={"Corduroy"} /> serves a rough and
            bass-heavy sound with driving rhythms. The variety in his sets
            ranges from different stiles of broken beats, bass, electro and
            beyond. corduroy is constantly looking for new progressive sounds
            outside the box of the mainstream. He mainly finds that in electro
            from Eastern Europe and UK bass at the moment. corduroy is a
            co-founder of the music and party collective pavement gum.
          </p>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/Pauli.jpeg"
          ></img>
          <p className="font-size-1">
            <PrettyName name={"Pauli"} />
            is a DJ from hanover, who is a part of the music collective pavement
            gum. She combines elements of breaks, techno and trance. Besides
            that, her sets are always filled with a lot of trash and fun.
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/Preach.jpeg"
          ></img>
          <p className="font-size-1">
            <PrettyName name={"PREACH"} />
            ist eine interdisziplinäre Künstlerin Die interdisziplinäre
            Künstlerin Jesseline Preach ist unter diversen Alter Egos im
            Kunstkosmos erfolgreich. Mit Preach, Fathoeburger und Afia Jamaica
            überzeugt sie mit deepen Beats, derben Texten und süßen Ohrwürmern,
            ihr Sound variiert zwischen HipHop, Pop und Experimental. Sie ist
            Mitbegründerin des Künstler*innen Kollektiv One Mother, die u. a.
            die Partyreihe BAD(B)ASS auf Kampnagel kuratieren und damit eine
            lokale Szene sichtbar machen, die sonst wenig vertreten ist.
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
          ...
          ></img>
          <p className="font-size-1">
            <PrettyName name={"€uro€y€z"} />
            (aka Yerin) is a 90s baby born and raised in Hamburg, Germany by
            Korean parents. By day, she runs a vegan Korean restaurant in the
            Sternschanze. At night she transforms into a (for now) underground
            Popstar. When the pandemic hit and the lockdowns alleviated Yerin of
            her busy restaurant routine, she started working on songs in
            collaboration with her producer and brother (yes, just like in the
            tale) jinO.o. Inspired by their Korean background and influenced by
            Pop, R&B, Jungle, and Trance, the two siblings naturally started
            making music together. Their vision came to life when they were
            asked to do a live stream for a collective they were part of.
            Watching many a live-stream DJ Set during the lockdown days, the
            siblings saw an opportunity to experiment with performance, covering
            Korean pop songs from the 1970s-2010s. Realizing they were a great
            team and understood each other's visions well, they wrote her debut
            single, "I C U (In My Dreams),". After the single and self-produced
            video release, jinO.o and €uro€y€z played a couple of concerts and
            joined the Hamburg-based collective OneMother. deutsch €uro€y€z
            (alias Yerin) ist ein Baby der 90er Jahre, geboren und aufgewachsen
            in Hamburg, Deutschland, bei koreanischen Eltern. Tagsüber betreibt
            sie ein veganes koreanisches Restaurant in der Sternschanze. Nachts
            verwandelt sie sich in einen (vorerst) unterirdischen Popstar. Als
            die Pandemie ausbrach und die Abriegelungen Yerin von ihrem
            Restaurantalltag entlasteten. Restaurant-Routine befreit, beginnt
            sie mit ihrem Produzenten und ihrem Produzenten und Bruder (ja,
            genau wie im Märchen) jinO.o. Inspiriert von ihrem koreanischen
            Hintergrund und beeinflusst von Pop, R&B, Jungle und Trance,
            begannen die beiden Geschwister natürlich, gemeinsam Musik zu
            machen. Ihre Vision wurde zum Leben erweckt, als sie gebeten wurden,
            einen Live-Stream für ein Kollektiv zu machen, dem sie zu machen.
            Als die Geschwister während des Lockdowns viele Live-Stream-DJ-Sets
            verfolgten, sahen sie eine sahen die Geschwister eine Gelegenheit,
            mit Performance zu experimentieren mit koreanische Popsongs aus den
            1970er-2010er Jahren. Sie erkannten, dass sie ein großartiges Team
            waren und die Visionen des jeweils anderen gut verstanden, schreiben
            sie ihre Debütsingle "I C U (In My Dreams)". Nach der
            Veröffentlichung der Single und des selbstproduzierten
            Videoveröffentlichung spielten jinO.o und €uro€y€z ein paar Konzerte
            und schlossen sich dem Hamburger Kollektiv OneMother an.
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <p className="font-size-1">
            <PrettyName name={"Gemini"} /> <PrettyName name={"Gems"} />
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/IMG_6713.jpeg"
          ></img>
          <p className="font-size-1">
            <PrettyName name={"Dream"} />
            <PrettyName name={"The"} />
            <PrettyName name={"Butchqueen"} />
            is a multidisciplinary creative, teacher and organizer living in
            Berlin. Once he realized Berlins need for more BIPOC queer parties,
            he started to learn how to DJ. His dream is to create spaces for the
            queer BIPOC community full of community events, balls and parties.
            His genrefluid range goes from ballroom beats to hiphop to house to
            jersey club beats to techno to trash and to whatever else he feels
            like that evening.
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/disk.o.gruppenbild_ChristelClerc.jpg"
          ></img>
          <p className="font-size-1">
            <PrettyName name={"DISK.O."} />
            heißt, ein wir zu schaffen - hier finden ohne Genrebeschränkungen
            viele Tanz- und Clubmusikrichtungen zusammen. Wir wollen gemeinsam
            Musikkultur neu entdecken und dabei vor allem eine gute Zeit haben.
            Seit 2014 spielen wir als DJ*-Kollektiv regelmäßig in Hildesheim und
            geben dabei die Möglichkeit, sich als neue*r DJ zu Gast
            auszuprobieren.
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/Orientalisman.jpeg"
          ></img>
          <p className="font-size-1">
            <PrettyName name={"Orientalisman"} />
            (she/her) ist eine kurdische DJ aus Hannover. In ihren Sets teilt
            sie die Musik, mit der sie aufgewachsen ist, aus dem arabischen und
            kurdischen Raum in Fusion mit House, R`n`B Tunes und Baile Funk. Mit
            einem geliehenen Controller und der Unterstützung ihrer
            Mitbewohnerin fing Orientalisman an aufzulegen. Durch ihren Namen,
            ihrem Stil und ihrem Goldschmuck reclaimt sie ihre Identität als
            kurdische Frau. Sie orientalisiert sich selbst, um die Stigmata und
            die Rassismen, welche mit den Begriffen „Orient" sowie
            „orientalisch" einhergehen, zu entmachten und neu zu definieren.
            Orientalisman ist Newcomerin, aber ihre Vision ist es, die weiß,
            cis-männlich dominierte Clubszene radikal, mit ihren Habibis an
            ihrer Seite, herauszufordern und mehr Räume für BIPoC FLINTA* zum
            booty shaken zu schaffen.
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/cansel.jpeg"
          ></img>
          <p className="font-size-1">
            <PrettyName name={"Cansel"} />
            (she/her) ist eine junge PoC aus Hannover. In erster Linie ist sie
            eine Hip Hop Tänzerin und hat mit dem auflegen angefangen, um
            weitere Elemente des Hip Hops kennenzulernen, um es mit anderen
            Menschen zu teilen. Mit der Musik die sie auflegt, möchte sie Spaß,
            Freude und Tanz auf der Fläche verbreiten. Sie versteht, dass die
            Musik die sie spielt, aus verschiedenen Kulturen kommen und sie
            versucht, diese wichtigen Elemente davon aufrechtzuerhalten.
          </p>
        </div>
        <div style={{ padding: " 1.5rem", lineHeight: "200%" }}>
          <img
            alt=""
            style={{ width: "100%", borderRadius: "2.2rem" }}
            src="/images/20230105-Sirenas-009.jpg"
          ></img>
          <p className="font-size-1">
            Das Dj-Duo <PrettyName name={"SIRENAS"} /> aus Bern zieht dich mit
            ihren sets in den Bann. Dich erwartet eine empowernde Ladung aus:
            reggaeton, baile funk, dembow, dancehall und rap. Mit ihrer
            anti-macho Attitüde, wollen sie einen Raum auf dem Dancefloor
            schaffen, in dem es möglich sein soll sich tanzend wohl und sexy zu
            fühlen. Mit ihren genreübergreifenden sets teilen sie die Musik, die
            sie selbst fühlen und feiern. Das Dj-Duo ist bei dem Label Force
            Field Records zuhause. xx Sirenaslove
          </p>
        </div>
      </>
    ),
