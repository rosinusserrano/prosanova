      ...
      <div className=" page-grid-inside inside-main-content-wrapper ">
        <div className="  inside-page-padding background-color-grey border-radius font-size-1 grid-6-column-mobile grid-3-column scrollable-element grid-child grid-row-start-2 no-scroll-bar">
          <div className="team-grid ">
            ...
            <WigglyButton onClick={() => scrollToPos("leni-bio")}>
            ...
            <WigglyButton onClick={() => scrollToPos("melek-bio")}>
              <div className="team-image">
                <img
                  src={Team2}
                  alt="Melek"
            ...
            <WigglyButton onClick={() => scrollToPos("hiyam-bio")}>
              <div className="team-image">
                <img
                  src={Team3}
                  alt="Hiyam"
            ...
            <WigglyButton onClick={() => scrollToPos("lucie-bio")}>
              <div className="team-image">
                <img
                  src={Team4}
                  alt="Lucie"
            ...
            <WigglyButton onClick={() => scrollToPos("lina-bio")}>
              <div className="team-image">
                <img
                  src={Team5}
                  alt="Lina"
            ...
            <WigglyButton onClick={() => scrollToPos("clara-bio")}>
              <div className="team-image">
                <img
                  src={Team6}
                  alt="Clara"
            ...
            <WigglyButton onClick={() => scrollToPos("anna-lena-bio")}>
              <div className="team-image">
                <img
                  src={Team7}
                  alt="Anna-Lena Maatz"
            ...
            <WigglyButton onClick={() => scrollToPos("bela-bio")}>
              <div className="team-image">
                <img
                  src={Team8}
                  alt="Bela Neumann"
            ...
            <WigglyButton onClick={() => scrollToPos("dilara-bio")}>
              <div className="team-image">
                <img
                  src={Team9}
                  alt="Dilara Buzoglu"
            ...
            <WigglyButton onClick={() => scrollToPos("leon-bio")}>
              <div className="team-image">
                <img
                  src={Team10}
                  alt="Leon Ahlhorn"
            ...
            <WigglyButton onClick={() => scrollToPos("linda-bio")}>
              <div className="team-image">
                <img
                  src={Team11}
                  alt="Linda Rabe"
            ...
            <WigglyButton onClick={() => scrollToPos("lynnve-bio")}>
              <div className="team-image">
                <img
                  src={Team12}
                  alt="Lynn Stechert"
            ...
            <WigglyButton onClick={() => scrollToPos("marlene-h-bio")}>
              <div className="team-image">
                <img
                  src={Team13}
                  alt="Marlene Horn"
            ...
            <WigglyButton onClick={() => scrollToPos("marlene-r-bio")}>
              <div className="team-image">
                <img
                  src={Team14}
            ...
            <WigglyButton onClick={() => scrollToPos("nima-bio")}>
              <div className="team-image">
                <img
                  src={Team15}
                  alt="Nima Schaper"
            ...
            <WigglyButton onClick={() => scrollToPos("roya-bio")}>
              <div className="team-image">
                <img
                  src={Team16}
                  alt="Roya Schaper"
            ...
            <WigglyButton onClick={() => scrollToPos("tilman-bio")}>
              <div className="team-image">
                <img
                  src={Team17}
                  alt="Tilman Busch"
            ...
            <WigglyButton onClick={() => scrollToPos("RombachLeah-bio")}>
              <div className="team-image">
                <img
                  src={Team18}
                  alt="Rombach Leah"
            ...
            <WigglyButton onClick={() => scrollToPos("SchelerJohanna-bio")}>
              <div className="team-image">
                <img
                  src={Team19}
                  alt="Scheler Johanna"
            ...
            <WigglyButton onClick={() => scrollToPos("WolterLuise-bio")}>
              <div className="team-image">
                <img
                  src={Team20}
                  alt="Wolter Luise"
